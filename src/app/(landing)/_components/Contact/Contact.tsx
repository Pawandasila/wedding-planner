        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className={`relative hidden md:block intro-animate-fadeInLeft ${isInView ? 'animate animation-delay-600' : ''}`}>
            <div className="relative">
              ...
              <div className="absolute -top-8 -right-8 w-24 h-24 md:w-32 md:h-32 bg-secondary-accent/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-secondary-accent/20">
                <div className="w-12 h-12 md:w-16 md:h-16 text-secondary-accent">
                  <svg fill="currentColor" viewBox="0 0 24 24">
